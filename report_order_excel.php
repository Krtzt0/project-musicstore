...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'รายงานข้อมูลการสั่งซื้อ')
            ->setCellValue('A3', 'รหัสการสั่งซื้อ')
            ->setCellValue('B3', 'ชื่อลูกค้า')
			->setCellValue('C3', 'ชื่อสินค้า')
            ->setCellValue('D3', 'ชื่อพนักงาน');
...
{
	$objPHPExcel->getActiveSheet()->setCellValue('A' . $i, $objResult["Order_id"]);
	$objPHPExcel->getActiveSheet()->setCellValue('B' . $i, $objResult["Customer_name"]);
	$objPHPExcel->getActiveSheet()->setCellValue('C' . $i, $objResult["Product_name"]);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $i, $objResult["Employee_firstname"]);

...
<body id="page-top">
	...
	?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">ข้อมูลพนักงาน</h1>
                    <a href="employee_pdf.php" target="_black" class="btn btn-primary">รายงานข้อมูลพนักงาน(pdf)</a>
                    <a href="report_employee_excel.php" target="_black" class="btn btn-primary">รายงานข้อมูลพนักงาน(Excel)</a>
                    <?php
                        //เชื่อมต่อฐานข้อมูล
                        ...
                        echo "<hr> จำนวนพนักงาน".$total."คน <hr>";

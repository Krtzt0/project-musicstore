...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('A3', 'รหัสสินค้า')
            ->setCellValue('B3', 'ชื่อสินค้า')
			->setCellValue('C3', 'ชื่อประเภทสินค้า')
...
$objPHPExcel->getActiveSheet()->getColumnDimension('C')->setWidth(30); // กำหนดความกว้างของแถว
$objPHPExcel->getActiveSheet()->getColumnDimension('D')->setWidth(30); // กำหนดความกว้างของแถว
...
{
	$objPHPExcel->getActiveSheet()->setCellValue('A' . $i, $objResult["Product_id"]);
	$objPHPExcel->getActiveSheet()->setCellValue('B' . $i, $objResult["Product_name"]);
	$objPHPExcel->getActiveSheet()->setCellValue('C' . $i,$objResult["Type_name"]);
	$objPHPExcel->getActiveSheet()->setCellValue('D' . $i,$objResult["Product_price"]);
